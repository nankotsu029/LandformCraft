...
/**
 * Thrown by {@link LakeBedMaterializationV2} when a {@code LAKE} basin cannot be materialized into
 * the final canonical block stream without breaking one of the declared interaction contracts
 * (V2-15-11).
 *
 ...
 */
public final class LakeMaterializationRejectedV2 extends IOException {
    ...
    LakeMaterializationRejectedV2(String ruleId, String featureId, int cellX, int cellZ, String detail) {
    ...
    private static String message(String ruleId, String featureId, int cellX, int cellZ, String detail) {
        ...
        return Objects.requireNonNull(ruleId, "ruleId")
                + " [" + LakeBedMaterializationV2.CONTRACT_VERSION + "] lake "
