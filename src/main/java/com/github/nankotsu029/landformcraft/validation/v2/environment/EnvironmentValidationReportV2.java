...
/** Stable machine-readable result of one independent environment validation pass. */
public record EnvironmentValidationReportV2(
        List<MetricResultV2> metrics,
        List<DiagnosticIssueV2> issues
) {
    public EnvironmentValidationReportV2 {
