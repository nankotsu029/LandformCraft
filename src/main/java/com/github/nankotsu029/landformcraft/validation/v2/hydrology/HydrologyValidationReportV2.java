...
/** Stable, machine-readable result of one independent hydrology validation pass. */
public record HydrologyValidationReportV2(
        List<MetricResultV2> metrics,
        List<DiagnosticIssueV2> issues
) {
    public HydrologyValidationReportV2 {
