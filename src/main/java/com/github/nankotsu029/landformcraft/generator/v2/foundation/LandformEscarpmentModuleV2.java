...
/** Built-in EXPERIMENTAL escarpment foundation module (V2-10-06). */
public final class LandformEscarpmentModuleV2 {
    public static final String MODULE_ID = EscarpmentPlanV2.MODULE_ID;
    public static final String MODULE_VERSION = EscarpmentPlanV2.MODULE_VERSION;
    public static final String STAGE_ID = "generate.foundation-escarpment";
    ...
    private final ModuleDescriptorV2 descriptor = new ModuleDescriptorV2(
            ...
            List.of(TerrainIntentV2.FeatureKind.ESCARPMENT),
            List.of(),
            PROVIDED,
            PROVIDED.stream()
            ...
            List.of("feature.escarpment.validator"),
            List.of("feature.escarpment.preview"));
