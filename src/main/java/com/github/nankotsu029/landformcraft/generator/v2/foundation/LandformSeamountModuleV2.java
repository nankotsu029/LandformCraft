...
/** Built-in EXPERIMENTAL seamount foundation module (V2-10-04). */
public final class LandformSeamountModuleV2 {
    public static final String MODULE_ID = SeamountPlanV2.MODULE_ID;
    public static final String MODULE_VERSION = SeamountPlanV2.MODULE_VERSION;
    public static final String STAGE_ID = "generate.foundation-seamount";
    ...
    private final ModuleDescriptorV2 descriptor = new ModuleDescriptorV2(
            ...
            List.of(TerrainIntentV2.FeatureKind.SEAMOUNT),
            List.of(),
            PROVIDED,
            PROVIDED.stream()
            ...
            List.of("feature.seamount.validator"),
            List.of("feature.seamount.preview"));
