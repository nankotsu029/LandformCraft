...
Taskは5トラックで管理する。Track A（V2-4→V2-5→V2-6→V2-17）、Track B（V2-7→V2-14 画像忠実性）、Track C（V2-8→V2-13 スケール）、Track D（V2-9 地形基盤拡張）、Track E（V2-10→V2-15→V2-16 地形拡張）である。V2-9／V2-10は完了済みで、2026-07-22全地形監査により既存planの公開接続をV2-15、deferred／new terrainとcompositionをV2-16、Paper実機証跡と昇格をV2-17へ分離した。V2-17は`V2-15-47`／`V2-16-19`を前提とし、実機未測定Featureを`SUPPORTED`へしない。各回は`docs/roadmap.md`が示す担当Trackの次の未完了`V2-x-NN`を1件だけ実行する。
