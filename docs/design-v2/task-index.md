...
| `V2-15-11` | 03,06,`V2-19-01` | `LAKE`＋oxbow cutoff subtype public wiring | dam reservoirはV2-16。**2026-07-23 stage gate: `V2-19-01`（semantic materialization gate）完了まで着手しない。以後の公開配線leafはblock materialization義務（final block streamからの非空効果・形状conformance）をAcceptanceへ含む** |
