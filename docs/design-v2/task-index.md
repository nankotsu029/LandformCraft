...
| C | V2-13 MEDIUM 1024 enablement／measurement | 5 | `V2-13-04`（`V2-13-01`〜`03` 2026-07-21完了。`V2-13-03`で1024² offline E2Eは hydrology／preview 1M cell budgetで拒否） | `V2-13-05`（実測により条件不成立で保留） |
