...
| C | V2-13 MEDIUM 1024 enablement／measurement | 5 | `V2-13-01` | `V2-13-05`（`V2-13-05`は条件付き） |
| B | V2-14 Image fidelity wiring follow-up | 2 | `V2-14-02`（`V2-14-01` 2026-07-21完了） | —（Phase gate Task未設定） |
...
- **状態:** 未着手（条件付き承認: `V2-13-01`でMap／allocationが主要ボトルネックと確認された場合のみ実行可）。
...
- **状態:** 未着手（条件: Schema／checksum互換性確認を先行させる）。
