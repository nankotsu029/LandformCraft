...
| A | V2-11 Capability promotion | 6 | `V2-11-06` | — |
...
- **Gate／docs／次／停止:** FAWE単独profileで`APPLIED`→full verify→`UNDONE`完走とserver PID単独telemetryが揃ったため完了。次は`V2-11-05`（完了済み）。500をcatalog昇格候補へは上げない（`V2-11-06`）。
